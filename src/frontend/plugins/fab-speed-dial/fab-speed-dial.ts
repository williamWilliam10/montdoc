...
@Component({
    selector: 'app-smd-fab-speed-dial',
    template: `
        <div class="smd-fab-speed-dial-container">
            <ng-content select="app-smd-fab-trigger"></ng-content>
            <ng-content select="app-smd-fab-actions"></ng-content>
        </div>
    `,
